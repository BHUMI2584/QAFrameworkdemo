package TestNgFrameworkWithDataProviderDemo;
...
public class TestNgFrameworkWithDataProviderDemo {
	...
	public Object[][] dpMethod(){
		return new Object[][] {{"India"}, {"Canada"}};
	}
	
	@Test (dataProvider = "data-provider")
	public void countrySearchTest(String countryName) throws Exception {
		
		searchField.sendKeys(countryName);
		searchField.sendKeys(Keys.ENTER);
		Thread.sleep(1000);
		Assert.assertTrue(driver.getCurrentUrl().contains(countryName));
		System.out.println(countryName + " Search Test Pass.");
